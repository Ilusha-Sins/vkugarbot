...
from vk_api.longpoll import VkLongPoll, VkEventType, VkChatEventType
tkn = ""#токен бота
idvk = 601642092#айди бота
ignorelist = [303494230,318338820]#игно пользователей
conf = []#игнор бесед
invusers=[599246827]#пользователи, которых нужно приглашать
title1=["࿗࿗࿗ᛋᛋСлава Русиᛋᛋ࿗࿗࿗","Слава Путину!","Слава ебалу!"]#Названия кф
photo = "photo.jpg"
            ...
            try:
                for event in longpoll.listen():
                    ...
                    if str(f) == 'chat_kick_user':
                        vk.messages.removeChatUser(chat_id=event.chat_id,user_id=event.user_id)
